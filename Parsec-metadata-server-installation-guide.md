...
In the case of a test environment, it is possible to run a postgresql database in a docker container. The following setup commands are provided for convenience:
```shell
